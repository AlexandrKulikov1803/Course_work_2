...
vacancy = Vacancy("Python Developer", "<https://hh.ru/vacancy/123456>", 100000, "Опыт работы от 3 лет")


# Сохранение информации о вакансиях в json-файл
json_saver = JSONWriter()
json_saver.add_data(vacancy)
json_saver.del_data(vacancy)


# Сохранение информации о вакансиях в txt-файл
txt_saver = TXTWriter()
txt_saver.add_data(vacancy)
txt_saver.del_data(vacancy)
